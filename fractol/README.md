...
5. Server should be able to receive strings from several clients in a row without
   needing to restart 1. Linux system does NOT queue signals when you already have pending
...
- minilibX : 
   - [https://www.youtube.com/watch?v=ANLW1zYbLcs](https://www.youtube.com/watch?v=ANLW1zYbLcs)
   - [https://harm-smits.github.io/42docs/libs/minilibx/events.html](https://harm-smits.github.io/42docs/libs/minilibx/events.html)
   - [https://harm-smits.github.io/42docs/libs/minilibx/events.html](https://harm-smits.github.io/42docs/libs/minilibx/events.html)
- fractol : [https://www.youtube.com/watch?v=ANLW1zYbLcs](https://www.youtube.com/watch?v=ANLW1zYbLcs)
...
AI was used to break down color grading logic (bit shifting vs. hex)._
